...
require_text "README.md" "Cortex 1.5 is a full rewrite"
require_text "README.md" "production-ready multi-user agent runtime"
require_text "README.md" "crates/cortex-runtime/tests/multi_user.rs"
require_text "README.zh.md" "Cortex 1.5 是一次面向生产多用户交付的完整重写"
