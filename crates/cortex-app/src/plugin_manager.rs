...
/// For example, packing `cortex-plugin-dev` with manifest version `1.2.0`
/// defaults to `cortex-plugin-dev-v1.2.0-linux-amd64.cpx`.
///
/// # Errors
...
/// Supports optional versions: `dev@1.2.0` or
/// `owner/cortex-plugin-dev@v1.2.0`.
///
/// # Errors
/// Returns an error message if the download or installation fails.
