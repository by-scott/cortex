...
/// For example, packing `cortex-plugin-dev` with manifest version `1.6.1`
/// defaults to `cortex-plugin-dev-v1.6.1-linux-amd64.cpx`.
///
/// # Errors
...
/// Supports optional versions: `dev@1.6.1` or
/// `owner/cortex-plugin-dev@v1.6.1`.
///
/// # Errors
/// Returns an error message if the download or installation fails.
