...
use cortex_types::{
    CorrelationId, Event, Goal, GoalLevel, GoalSource, GoalStatus, MemoryEntry, MemoryKind,
    MemoryType, Payload, SharedTask, SharedTaskStatus, TurnId,
};
...
impl RpcHandler {
    ...
    fn handle_task_create(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let description = req
            .params
            .get("description")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_task_list(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let actor = self.state.transport_actor(client);
    ...
    fn handle_task_get(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_task_delete(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_task_claim(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_task_update(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_goal_create(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let description = req
            .params
            .get("description")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_goal_list(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let actor = self.state.transport_actor(client);
    ...
    fn handle_goal_get(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_goal_delete(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
    ...
    fn handle_goal_update(&self, req: &RpcRequest, client: &str) -> RpcResponse {
        let id = req
            .params
            .get("id")
            .and_then(serde_json::Value::as_str)
